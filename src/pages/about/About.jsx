    ...
    <>
      ...
      <div className="about">
        <div className="row  aboutSection">
          ...
          <div class="col-md-5">
            ...
            <p class="aboutDesc">
              ...
              alias nisi voluptate est quibusdam. Rerum nesciunt recusandae, cum
              sed impedit dicta beatae amet quae quasi illum illo nisi,
              consequatur nostrum? Lorem ipsum dolor sit amet consectetur
              adipisicing elit. Velit alias nisi voluptate est quibusdam. Rerum
              nesciunt recusandae, cum sed impedit dicta beatae amet quae quasi
              illum illo nisi, consequatur nostrum?
            </p>
          </div>
          <div class="col-md-1"></div>
        </div>
        ...
        <div className="middle">
          <h1 className="middleTitle text-center">Our Creative Team</h1>
          <h5 class="sub-heading text-center">Meet Our client service Heros</h5>
        </div>
